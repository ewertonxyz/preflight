...
/// person authored, the other holds a value whose whole purpose is to change —
/// <c>pipeline use</c> exists to overwrite the pin, every time it is run. A
/// refactor that unifies the two has to break one of the pair.
/// </remarks>
