...
/// </summary>
/// <remarks>
/// Against a real temporary directory rather than a substitute: this type exists
/// to touch the disk, and a test that replaced the disk would assert nothing
/// about the only thing it does. <c>InstallRootWriterTests</c> is the other half
/// of the pair — that one replaces a directory every time, this one refuses to
/// replace a file ever, and neither promise survives a refactor that merges them.
/// </remarks>
