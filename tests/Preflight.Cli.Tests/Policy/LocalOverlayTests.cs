namespace Preflight.Cli.Tests.Policy;
...
public sealed class LocalOverlayTests
{
    ...
    /// intermittently. Determinism is the first thing this tool promises, and an
    /// intermittent break is the shape of failure it is worst at: the run that
    /// disagrees is the one nobody can reproduce.
    /// </remarks>
    [Fact]
