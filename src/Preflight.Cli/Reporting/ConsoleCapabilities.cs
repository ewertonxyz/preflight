...
/// terminal width. One record, built once by
/// <c>PreflightCommandLine.RealEnvironment</c> from the real console and
/// injected everywhere else, is the only arrangement in which both are
/// testable.
/// </para>
/// </remarks>
