...
/// is a parser to write and test in order to say what two keys already say, and
/// the workspace manifest has spelled a version range this way since
/// <c>Docs/design.md 9</c>. See ADR-032.
/// </para>
/// </remarks>
