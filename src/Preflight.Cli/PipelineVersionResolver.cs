...
/// discard the one value somebody wrote by hand. It is the inference ADR-029
/// refused, one storey up.
/// </para>
/// </remarks>
public static class PipelineVersionResolver
{
    ...
    /// looking — the inference ADR-029 refused for the pipeline name, one storey
    /// up. A pin whose directory is gone is the same refusal for the same
