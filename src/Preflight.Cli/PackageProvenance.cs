...
/// packages produce byte-identical output. See ADR-034.
/// </para>
/// </remarks>
public static class PackageProvenance
{
    ...
    public static PolicyDocument Qualify(PolicyDocument document, InstalledPipeline package)
    {
        ...
        return new PolicyDocument
        {
            ...
            // account name of whoever ran the tool — into a message that reaches
            // a CI log. ADR-034 nº7 forbids exactly that, and this is the second
            // door into it.
            //
